...
#define ADC_CR1_6B_RESOLUTION       ADC_CR1_RES_0 | ADC_CR1_RES_1
   ...
   * ADC_CR2_EXTEN_RISING - trigger ADC conversion on rising edge
   ...
   */
  .cr2          = ADC_CR2_EXTEN_RISING | ADC_CR2_EXTSEL_SRC(0b1100) /* here set TIM4_TRGO */,
  /*
...
/*
 * GPT configuration, this timer is used as trigger for the ADC.
 */
static const GPTConfig gpt_cfg = {
  /* Frequency of timer, resolution is 16 bit (DS p38) */
  .frequency =  100000,
  /* Callback of timer overflow event */
  .callback  =  NULL,
  /*
   * MMS = 010 = TRGO on Update Event (RM p924)
   * Update event is selected as trigger output
   */
  .cr2       =  TIM_CR2_MMS_1,
  /* Direct GPT register set, nothing here */
  .dier      =  0U
};
...
int main(void)
{
     ...
     * 	counter: 	10000,
     * 	freq: 		100000,
     * 	time between conversions (overflow period): 10000/100000 = 0.1s
