...
Как начать работу с таймером и оповестить об этом МК написано в [основах работы с модулями](Basics.md) =).
...
* `sqr3` - регистр настройки последовательности снятия аналогового сигнала и записи в буффер, возможные значения:
