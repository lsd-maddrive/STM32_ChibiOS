...
<center><img src="i2c_pics/fig1.png" width=700/></center>
...
функция повторного старта есть по умолчанию. Таким образом данная функция сначала передаёт информацию, а затем считывает. Если не понятно зачем функция повторного старта вообще нужна - изучайте протокол `i2c`.
